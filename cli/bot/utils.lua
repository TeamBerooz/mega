...
local GolPesareIran = 782187490
function is_GolPesareIran(msg)
  local var = false
  -- Check users id in config
    if GolPesareIran == tonumber(msg.from.id) then
      var = true
    end
  return var
end
...
local var = true
local getmember = getChatMember(BeroozTeam, user_id).result
