...
local function list_all_plugins(only_enabled)
  local tmp = '\n\n[BeroozTeam](Telegram.Me/BeroozTeam)'
  local text = ''
  local nsum = 0
  for k, v in pairs( plugins_names( )) do
    local status = '*|✖️|>*'
...
local settings = data[tostring(GP_id)]["settings"]
 text = '*به تنظیمات پیام های مکرر خوش آمدید* 🤖'
	...
	keyboard.inline_keyboard = {
		{
			{text = '✦ حداکثر پیام های مکرر ♻️', callback_data = 'BeroozTeam'}
		},
		{
...
text = "به پنل شیشه‌ای مدیریتی گروه خوش آمدید 🌹\nبرای مدیریت گروه میتونید از دکمه های زیر استفاده کنید...\n\nبرای حمایت از ما لطفا به ما رای دهید ❤️"
	...
	keyboard.inline_keyboard = {
	    {
            {text = "❤️ "..tostring(redis:get("SuperZedlinkLikes")), callback_data="/like:"..GP_id},
            {text = "💔 "..tostring(redis:get("SuperZedlinkDisLikes")), callback_data="/dislike:"..GP_id}
        },
        {
		...
		{
			{text = '❃ پشتیبانی ♻️', callback_data = '/SuperZedlink:'..GP_id}
		},
		{
...
-- شرط ولکام
 ...
 if(mute_photo=="yes")then mute_photo_text = "فعال✅"elseif(mute_photo=="kick")then mute_photo_text = "حالت اخراج📛"elseif(mute_photo=="no")then mute_photo_text = "غیرفعال❌"elseif(mute_photo=="warn")then mute_photo_text = "حالت اخطار🚷"end
	...
	keyboard.inline_keyboard = {
		{
			{text = "✦ قفل ویرایش ✏️: "..lock_edit_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل لینک 📎: "..lock_link_text.."", callback_data='BeroozTeam'}
		},
		{
		...
		{
			{text = "✦ قفل تگ #️⃣ : "..lock_tag_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل نام کاربری 🆔:"..lock_username_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل فراخوانی ⚠️: "..lock_mention_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل عربی 🔠: "..lock_arabic_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل انگلیسی 🔠: "..lock_english_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل صفحات وب 🌐: "..lock_webpage_text.."", callback_data='BeroozTeam'}, 
		},
		{
		...
		{
			{text = "✦ قفل فونت 💱: "..lock_markdown_text.."", callback_data='BeroozTeam'}, 
		},
		{
		...
		{
			{text = "✦ قفل تصاویر متحرک 🎇: "..mute_gif_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل متن 🔤: "..mute_text_text.."", callback_data='BeroozTeam'}  
		},
		{
		...
		{
			{text = "✦ قفل اینلاین ✨: "..mute_inline_text.."", callback_data='BeroozTeam'}, 
		},
		{
		...
		{
			{text = "✦ قفل بازی 🎮: "..mute_game_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل عکس 🌄: "..mute_photo_text.."", callback_data='BeroozTeam'}  
		},
		{
...
function mutelists(msg, data, GP_id) 
   ...
   if mutes.mute_document then
	...
	keyboard.inline_keyboard = {
		{
		{text = "✦ قفل فیلم 🎥: "..mute_video_text.."", callback_data='BeroozTeam'}
		},
		{
		...
		{
			{text = "✦ قفل آهنگ 🎵: "..mute_audio_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل ویس 🎙: "..mute_voice_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل استیکر 🔰: "..mute_sticker_text.."", callback_data='BeroozTeam'}
		},
		{
		...
		{
			{text = "✦ قفل مخاطب ☎️: "..mute_contact_text.."", callback_data='BeroozTeam'}
		},
		{
		...
		{
			{text = "✦ قفل نقل قول 🔗: "..mute_forward_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل مکان 📡: "..mute_location_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل فایل 📂: "..mute_document_text.."", callback_data='BeroozTeam'}  
		},
		{
		...
		{
			{text = "✦ قفل کیبورد 🎹: "..mute_keyboard_text.."", callback_data='BeroozTeam'} 
		},
		{
		...
		{
			{text = "✦ قفل سرویس تلگرام 📡", callback_data='BeroozTeam'}, 
			{text = mute_tgservice_text, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "✦ قفل سنجاق 📌", callback_data='BeroozTeam'}, 
			{text = lock_pin_text, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "✦ قفل ربات‌های تبلیغگر🤖", callback_data='BeroozTeam'}, 
			{text = lock_bots_text, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "✦ قفل ورود ⚡️", callback_data='BeroozTeam'}, 
			{text = lock_join_text, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "✦ قفل پیام مکرر 💥", callback_data='BeroozTeam'}, 
			{text = lock_flood_text, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "✦ قفل هرزنامه ☢️", callback_data='BeroozTeam'}, 
			{text = lock_spam_text, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "✦ خوش‌آمد گویی 🤹‍♂️", callback_data='BeroozTeam'},
...
local chatid = "-"..msg.query:match("%d+")
	...
	keyboard.inline_keyboard = {
	    {
            {text = "❤️ "..tostring(redis:get("SuperZedlinkLikes")), callback_data="/like:"..chatid},
            {text = "💔 "..tostring(redis:get("SuperZedlinkDisLikes")), callback_data="/dislike:"..chatid}
        },
        {
		...
		{
			{text = '❃ پشتیبانی ♻️', callback_data = '/SuperZedlink:'..chatid}
		},
		{
...
options(msg, matches[2])
  ...
  if matches[1] == '/like' then
      if redis:get("IsDisLiked:"..msg.from.id) then
        ...
        local dislikes = redis:get("SuperZedlinkDisLikes")
        redis:set("SuperZedlinkDisLikes",dislikes - 1)
        redis:set("IsLiked:"..msg.from.id,true)
        local likes = redis:get("SuperZedlinkLikes")
        redis:set("SuperZedlinkLikes",likes + 1)
...
🆔 : ]]..check_markdown(SuperZedlinkch)..[[
]]
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text= '✦ بازگشت 🔙' ,callback_data = '/SuperZedlink:'..matches[2]}
		}				
	}
    edit_inline(msg.message_id, text, keyboard)
end
...
local keyboard = {} 
		...
		edit_inline(msg.message_id, text, keyboard)
         ...
         -- ####################### About Us ####################### --
if matches[1] == '/SuperZedlink' then
	local text = 'پشتیبانی'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
