...
bot_token = "1180527087:AAFAg9AJFsSvAPk7gz4qfgue2vbH3MjAmhg" -- در اینجا توکن ربات api  را قرار دهید
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 782187490 -- ایدی سودوی اصلی را قرار دهید
SuperZedlinkch = '@BeroozTeam' -- یوزرنیم کانال خود را قرار دهید
SuperZedlinkby = '@BeroozTeam' -- یوزرنیم خود را قرار دهید
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeroozTeam = '/root/SuperZedlink/cli'
	elseif not server_user:match("^root$") then
		BeroozTeam = '/home/'..server_user..'/SuperZedlink/cli'
	end
  ...
  config = {
    ...
    sudo_users = {782187490,1180527087,902464546,1096913751,97476012}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..BeroozTeam..'/data/moderation.json'},
  }
